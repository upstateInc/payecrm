...
<html xmlns="http://www.w3.org/1999/xhtml"><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style>
  ...
  <title>PayeHub Payment Application </title>
    ...
    <link rel="icon" type="image/png" href="http://www.payehub.com/connect/img/favicon.png"/>
	  		...
	  		<link rel="stylesheet" href="<?php echo base_url();?>asset/bootstrap.min.css" type="text/css">
	  		<link rel="stylesheet" href="<?php echo base_url();?>asset/custom-styles.css" type="text/css">
...
.alert-success {
  ...
  <?php } else if($_SERVER['PHP_SELF']=="/ach-merchant-account-providers.php"){?>
  ...
  <?php } else if($_SERVER['PHP_SELF']=="/adult-merchant-account.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/merchant-credit-card-chargeback.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/online-credit-card-processing.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/credit-repair-service-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/e-cigarette-merchant-accounts-services.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/ecommerce-merchant-account-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/high-risk-merchant-account-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/international-merchant-account-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/low-risk-merchant-account-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/merchant-account-service-provider.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/best-online-pharmacy-merchant-accounts.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/tobacco-merchant-account-service-provider.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/travel-merchant-account-service-provider.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/telemarketing-merchant-account-service.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/prepaid-credit-cards-merchant-account.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/retail-merchant-accounts-service-provider.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/best-tech-support-merchant-account-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/echeck.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/controlcb.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/currency-exchange-service-providers.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/debt-collection-agency.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/subscription.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/partners.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/security.php"){?>
    ...
    <?php } else if($_SERVER['PHP_SELF']=="/privacy-policy.php"){?>
