...
<!-- Stage 1 -->					
						...
						<h5>General Business Information   <a class="btn btn-primary" href="<?php echo  base_url();?>applicationForm/business?signupid=<?php echo $this->session->userdata ( 'id' ); ?>">Edit</a></h5>					
						<div class="col-lg-6">						
...
<!-- Stage 2 -->
						...
						<h5>Designated Administrator   <a class="btn btn-primary" href="<?php echo  base_url();?>applicationForm/billing?signupid=<?php echo $this->session->userdata ( 'id' );?>">Edit</a></h5>					
						<div class="col-lg-6">						
...
<!-- Stage 3 -->
						...
						<h5>Files:<a class="btn btn-primary" href="<?php echo  base_url();?>applicationForm/document?signupid=<?php echo $this->session->userdata ( 'id' );?>">Edit</a></h5>
						<div class="col-lg-6">
							<?php if($billing['doc1']):?><div><label>Document File:</label> <?php if($billing['doc1']) echo $billing['doc1'];?></div><?php endif;?>
							<?php if($billing['doc2']):?><div><label>Document File:</label> <?php if($billing['doc2']) echo $billing['doc2'];?></div><?php endif;?>
							<?php if($billing['doc3']):?><div><label>Document File:</label> <?php if($billing['doc3']) echo $billing['doc3'];?></div><?php endif;?>
							<?php if($billing['doc4']):?><div><label>Document File:</label> <?php if($billing['doc4']) echo $billing['doc4'];?></div><?php endif;?>
							<?php if($billing['doc5']):?><div><label>Document File:</label> <?php if($billing['doc5']) echo $billing['doc5'];?></div><?php endif;?>
						</div>
						<div class="panel clearfix"></div>
						</fieldset>
