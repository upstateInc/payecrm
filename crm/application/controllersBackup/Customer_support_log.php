...
class Customer_support_log extends CI_Controller 
{
	public function __construct() {
		...
		$this->table = 't_customer_support_log';
		$this->viewfolder = 'customer_support_log/';
		$this->controllerFile = 'customer-support-log/';
		$this->namefile = 'customer_support_log';
	}
