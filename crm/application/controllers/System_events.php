...
class System_events extends CI_Controller 
{
	public function __construct() {
		...
		$this->table = 't_systemEvents';
		$this->viewfolder = 'system_events/';
		$this->controllerFile = 'system_events/';
		$this->namefile = 'system_events';
	}
