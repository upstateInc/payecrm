...
class Mid_report extends CI_Controller 
{
	public function __construct() {
		...
		$this->authentication->is_NomineeSystemAdmin($this->session->userdata('ADMIN_PERMISSION'));
		$this->table = 't_invoice';
		$this->viewfolder = 'mid_report/';
		$this->controllerFile = 'mid_report/';
		$this->namefile = 'Mid_Report';
	}
...
/**********************search*************************************/
		...
		$data['where_clause2'] = $where_clause1;
