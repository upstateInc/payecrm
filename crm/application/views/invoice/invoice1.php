<table id="tbl_content_area" width="100%" border="0" cellspacing="0" cellpadding="5">
	...
	<?php 
		...
		if($getRollingReserve->num_rows()>0) { ?>
			<tr><td colspan="5" align="center" ><strong>Reserve Rolling Transactions</strong></td></tr>
			<tr><td colspan="5" height="5px;" ></td></tr>
			<tr>
				 <td align="left"  class="td_tab_main" bgcolor="#eeeeee" style="" colspan="2" ><strong>Start Date</strong></td>
				 <td align="left"  class="td_tab_main" bgcolor="#eeeeee" style="" colspan="2"><strong>Release Date</strong></td>
			...
			?>	
				<tr>
					<td align="left" colspan="2" ><?php echo date("m-d-Y", strtotime($rowRolling->start_date)); ?></td>
					<td align="left" colspan="2" ><?php echo date("m-d-Y", strtotime($rowRolling->release_date)); ?></td>
