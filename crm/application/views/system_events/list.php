...
<!------------------------search section------------------------>
			...
			<div class="form-group">			
				<input type="text" class="form-control" name="event" id="event" value="<?php echo $event; ?>" placeholder="Events"/>	
			</div>
            ...
            <table class="table">
              <thead>
                <tr>
					...
					<th><a style="text-decoration:none;font-size:12px;font-weight:<?=($order_by_fld=='event')?'bold':'normal'?>;" href="javascript: hdnSort('event','<?php echo $order_by; ?>');">Event</a></th>
