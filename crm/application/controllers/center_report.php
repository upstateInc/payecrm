...
class Center_report extends CI_Controller 
{
	public function __construct() {
		...
		$this->authentication->is_GroupSystemAdmin($this->session->userdata('ADMIN_PERMISSION'));
		$this->table = 't_invoice';
		$this->viewfolder = 'center_report/';
		$this->controllerFile = 'center_report/';
		$this->namefile = 'Center_report';
...
/**********************search*************************************/
	...
	public function download(){
	   ...
	   $objPHPExcel->getProperties()->setTitle("Center Report")->setDescription("none");
		...
		header("Content-Disposition: attachment; filename=center_report.xls");
		ob_end_clean();
