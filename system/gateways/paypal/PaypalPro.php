...
class PaypalPro
{
    ...
    */
    ...
    public function paypalCall($params){
		...
		$nvpstr = "&PAYMENTACTION=".$params['paymentAction']."&AMT=".$params['amount']."&CREDITCARDTYPE=".$params['creditCardType']."&ACCT=".$params['creditCardNumber']."&EXPDATE=".$params['expMonth'].$params['expYear']."&CVV2=".$params['cvv']."&FIRSTNAME=".$params['firstName']."&LASTNAME=".$params['lastName']."&EMAIL=".$params['email']."&CUSTOM=".$params['custom']."&STREET=".$params['street']."&CITY=".$params['city']."&STATE=".$params['state']."&ZIP=".$params['zip']."&COUNTRYCODE=".$params['countryCode']."&CURRENCYCODE=".$params['currencyCode']."&IPADDRESS=".$params['ipaddress']."&INVNUM=".$params['invoice'].	"&SHIPTONAME=".$params['firstName'].$params['lastName']."&SHIPTOSTREET=".$params['street']."&SHIPTOCITY=".$params['city'].	"&SHIPTOSTATE=".$params['state']."&SHIPTOZIP=".$params['zip']."&SHIPTOCOUNTRY=".$params['countryCode']."&SHIPTOPHONENUM=".$params['phone'].$recurringStr;
