          ...
          <div class="x_panel">
                  <div class="x_content">
						...
						<div class="col-md-3 col-sm-3 col-xs-12 margine_bottom_5">
							  <input type="text" name="module" id="autocomplete-custom-append" value="<?php echo $module; ?>" placeholder="Module Name" class="form-control col-md-10">
							</div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title"><a style="text-decoration:none;font-size:12px;font-weight:<?=($order_by_fld=='module')?'bold':'normal'?>;" href="javascript: hdnSort('module','<?php echo $order_by; ?>');">Module</a> </th>
                            <th class="column-title"><a style="text-decoration:none;font-size:12px;font-weight:<?=($order_by_fld=='moduleLink')?'bold':'normal'?>;" href="javascript: hdnSort('moduleLink','<?php echo $order_by; ?>');">Module Link </a></th>
                            <th class="column-title"><a style="text-decoration:none;font-size:12px;font-weight:<?=($order_by_fld=='moduleDesc')?'bold':'normal'?>;" href="javascript: hdnSort('moduleDesc','<?php echo $order_by; ?>');">Module Desc </a> </th>
						...
						?>
                          <tr class="<?php echo $rowType;?> pointer">
                            ...
                            <a href="<?php echo site_url($this->controllerFile.'editPerm/'.$row->id);?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>.Perm </a>
