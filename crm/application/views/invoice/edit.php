...
<table id="tbl_content_area" width="100%" border="0" cellspacing="0" cellpadding="5">
	...
	<tr>
                ...
                <div class="sub_heading">
                    <table width="100%">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                          ...
                          <tr>
                            <td><strong>Company Name:</strong> <?php echo $this->session->userdata('INVOICECOMPANYID');?></td>
                          </tr>
                          <tr>
                            <td><strong>Processing Period:</strong> <?php echo $this->session->userdata('STARTDATE');?> to <?php echo $this->session->userdata('ENDDATE');?></td>
                          </tr>
                          <tr>
                            <td><strong>Days in Arrears:</strong> <?php echo $this->session->userdata('NOOFDAYS');?></td>
                          </tr>
                          <tr>
     ...
     <table width="100%" style="border: 0px solid rgb(153, 153, 153);" cellpadding="1" cellspacing="0" >
      ...
      <tr>
        ...
        <td align="right">&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('TOTALSALE');?></td>
      </tr>	
      <tr <?php if($this->session->userdata('INVOICETYPE')=="Gross"){ ?> style="display:none;" <?php } ?>>
        <td >Refunds</td>
        <td align="right">&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('NETREFUND');?></td>
      </tr>
      <tr <?php if($this->session->userdata('INVOICETYPE')=="Net"){ ?> style="display:none;" <?php } ?>>
        <td>Processing Fee</td>
        <td align="right">&nbsp;</td>
        <td align="right"><?php echo $this->session->userdata('COMMISSIONFEE');?>%</td>
        <td align="right">$ <?php echo $this->session->userdata('TOTALGOODSALE');?></td>
        <td align="right">$ <?php echo $this->session->userdata('PROCESSINGFEE');?></td>
      </tr>      
	  <tr>
	  <tr <?php if($this->session->userdata('INVOICETYPE')=="Net"){ ?> style="display:none;" <?php } ?>>
        <td>Rolling Reserve</td>
        <td align="right">&nbsp;</td>
        <td align="right"><?php echo $this->session->userdata('RESERVEPERCENTAGE');?>%</td>
        <td align="right">$ <?php echo $this->session->userdata('TOTALGOODSALE');?></td>
        <td align="right">$ <?php echo number_format($this->session->userdata('TOTALRESERVE'),2);?></td>
      </tr> 	  
        <td colspan="4" bgcolor="#eeeeee">Net Settled Volume</td>
        <td align="right" bgcolor="#eeeeee" >$ <?php echo $this->session->userdata('TOTALGOODSALE');?></td>
      </tr>	  
      <tr <?php if($this->session->userdata('INVOICETYPE')=="Gross"){ ?> style="display:none;" <?php } ?>>
        <td  >Processing Fee</td>
        <td align="right">&nbsp;</td>
      ...
      <tr>
        <td>Refund Fee</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('REFUNDEACH');?></td>
        <td align="right"><?php echo $this->session->userdata('NOREFUND');?></td>
        <td align="right">$ <?php echo $this->session->userdata('TOTALREFUND');?></td>
      </tr>
      <tr>
        <td >Chargeback Fee</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('CHARGEBACHEACH');?></td>
        <td align="right"><?php echo $this->session->userdata('NOCHARGEBACK');?></td>
        <td align="right">$ <?php echo $this->session->userdata('TOTALCHARGEBACK');?></td>
      </tr>
	  <?php if($this->session->userdata('ACHFEE')>0){?> 
      <tr>
        <td >ACH Fee</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('ACHFEE');?></td>
        <td align="right">1</td>
        <td align="right">$ <?php echo $this->session->userdata('ACHFEE');?></td>
      </tr>
	  <?php } ?>
	  <?php if($this->session->userdata('WIREFEE')>0){?>
      <tr>
        <td >Wire Fee</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo strtok($this->session->userdata('WIREFEE'),'.');?></td>
        <td align="right">1</td>
        <td align="right">$ <?php echo $this->session->userdata('WIREFEE');?></td>
      </tr>
	  <?php } ?>
	  <tr>
      ...
      <tr>
        ...
        <td bgcolor="#eeeeee" >&nbsp;</td>
        <td bgcolor="#eeeeee" >&nbsp;</td>
        <td align="right" bgcolor="#eeeeee"><strong>$ <?php echo $this->session->userdata('NETDEDUCTION');?></strong></td>
      </tr>
	  <tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
      ...
      <table width="100%" style="border: 0px solid rgb(153, 153, 153);" cellpadding="1" cellspacing="0" >
      <tr>
        <td bgcolor="#eeeeee" style="border-bottom:1px solid #000;"><strong>Payment</strong></td>
        <td bgcolor="#eeeeee" align="right" style="border-bottom:1px solid #000;">&nbsp;</td>
        <td bgcolor="#eeeeee" align="right" style="border-bottom:1px solid #000;">&nbsp;</td>
        <td bgcolor="#eeeeee" align="right" style="border-bottom:1px solid #000;">&nbsp;</td>
      ...
      <tr>
        ...
        <td align="right">&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td align="right">$ <?php echo $this->session->userdata('NETCHARGEBACK');?></td>
      </tr>
      <tr>
        <td >Invoice Amount</td>
        <td colspan="3">&nbsp;</td>
        <td style="text-align:right;">$ -<?php echo $this->session->userdata('NETDEDUCTION');?></td>
      </tr>	
	  <tr>
      ...
      <!--tr>
        ...
        <td width="10%" align="right" style="border-top:1px solid #000;text-align:right;">&nbsp;</td>
        <td width="20%" align="right" style="border-top:1px solid #000; text-align:right;">$ <?php echo $this->session->userdata('TOTALGROSSSALE');?></td>
      </tr-->
      ...
      <tr>
		...
		<?php if($query->num_rows() > 0){
			...
			foreach ($query->result() as $row){
				...
				if($row->credit=='Y'){
					$moreTotalDeduction=$moreTotalDeduction+$row->total;
				}
				else if($row->credit=='N'){
					$moreTotalDeduction=$moreTotalDeduction-$row->total;
				}
				?>
				<tr style="background:<?php echo $color;?>">
					<td width="20%" ><?php echo $row->name;if($row->credit=='Y'){ echo '(Cr.)'; }else{ echo '(Dr.)';} ?></td>
					<td width="30%"> $ <input type="text" id="price_each<?php echo $row->id; ?>" value="<?php echo $row->price_each; ?>"/></td>
					<td width="10%" > <input type="text" id="quantity<?php echo $row->id; ?>" value="<?php echo $row->quantity; ?>"/></td>
					<td width="10%" ><?php echo '$ '.$row->total; ?></td>
					<td width="20%" >
						<a href="javascript:void(0);" onclick="edit(<?php echo $row->id;?>);" class="btn btn-primary btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a>
						<a href="javascript:void(0);" onclick="deleteRec(<?php echo $row->id;?>);" class="btn btn-primary btn-xs" ><span class="glyphicon glyphicon-remove"></span></a>
					</td>
				</tr>
		<?php } } ?>
		<input type="hidden" id="total_payout" name="total_payout" value="<?php echo number_format($this->session->userdata('NETPAYOUT') - $moreTotalDeduction,2);?>"/>
      <!--tr>	  
        <td >Settlement Amount</td>
        <td colspan="3">&nbsp;</td>
        <td align="right">$ <?php echo number_format($this->session->userdata('NETPAYOUT') - $moreTotalDeduction,2);?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td  bgcolor="#eeeeee" align="right" style="border-top:1px solid #000; border-bottom:1px double #000;"><strong>$ <?php echo number_format($this->session->userdata('NETPAYOUT') - $moreTotalDeduction,2);?></strong></td>
      </tr>
	  	<tr>
		<td>
		<input type="button" class="btn btn-primary btn-xs" onclick="addDetailInvoice();" name="save" value="Save Invoice"/> 
		</td>
		<td id="Invoice_button" style="display:none;"> 
		...
		$InvoiceCC = $this->db->query("select invoiceEmails from t_centerdb where companyID like '%".$this->session->userdata('INVOICECOMPANYID')."%' ")->row()->invoiceEmails;
		//echo $this->db->last_query();
		?>
		<!--td  id="showEmail" colspan="2">
		...
		<td>
			...
			<a href="javascript:void(0);" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#send_invoice" onclick="addDetailInvoice2();">Email Invoice</a>
		</td>
				<td>
		<a href="<?php echo site_url('invoice/volumeReport?companyID='.$this->session->userdata('INVOICECOMPANYID').'&startdate='.$this->session->userdata('STARTDATE').'&enddate='.$this->session->userdata('ENDDATE'));?>" class="btn btn-primary btn-xs" ><span class="glyphicon glyphicon-download"></span> Volume Report</a>
		</td>
	</tr>
    </table>
	...
	<tr><td height="10px;"></td></tr>
		<!--------------------------------------Volume Report------------------------------------------->
	<?php			
		$companyID=$this->session->userdata('INVOICECOMPANYID');
...
<script type="text/javascript"> 
	function addDetailInvoice(){
		...
		if (r == true) {
			$.post('<?php echo base_url().$this->controllerFile; ?>addDetailInvoice', 'tempInvoiceGenerationId='+tempInvoiceGenerationId+"&total_payout="+total_payout, function(data){
				if(data) 
				{
					$("#msgDiv").show("");
	...
	function sendMail(){
		...
		/*var r=confirm("Are you sure want to Save the Invoice?");
		if (r == true) {*/
			$.post('<?php echo base_url().$this->controllerFile; ?>sendEmailsave', 'tempInvoiceGenerationId='+tempInvoiceGenerationId+"&total_payout="+total_payout+"&emailList="+emailList, function(data){
				if(data) 
				{
					$("#msgDiv").show("");
